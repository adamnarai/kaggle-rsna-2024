...
from .datasets import RSNA2024Dataset, RSNA2024SplitDataset, RSNA2024SplitCoordDataset
...
class RSNASplitCoordDataLoader(DataLoader):
    def __init__(
        ...
        dataset = RSNA2024SplitCoordDataset(df, data_dir, out_vars, img_num=img_num, transform=transform)
        if phase == 'train':
            pass
        elif phase == 'valid':
            shuffle = False
